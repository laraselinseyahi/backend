...
def process_datavis():
    xls = pd.ExcelFile('/Users/lseyahi/desktop/glo_test.xlsx')
...
def process_files():
    ...
    TBNK_col = general_info + TBNK_Day0_Pre + TBNK_Day0_Post + TBNK_Day9_Final + ['ratio1', 'ratio2', 'ratio3']
    ...
    cytotox = general_info + (df.iloc[0:3, 10]).to_list() + [1, 2, 3]
    ...
    excel_file = pd.ExcelFile('/Users/lseyahi/desktop/glo_test.xlsx')
...
desktop_path = "/full/path/to/your/desktop"
